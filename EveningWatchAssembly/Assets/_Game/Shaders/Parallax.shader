...
/////// Normals:
                float2 node_35 = (i.uv0.rg*12.0);
                float2 node_110 = (0.1*(tex2D(_AORGBHeightA,TRANSFORM_TEX(node_35, _AORGBHeightA)).a - 0.5)*mul(tangentTransform, viewDirection).xy + node_35);
